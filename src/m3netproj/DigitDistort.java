...
public class DigitDistort //DOESN'T ACTUALLY DISTORT
{
    ...
    public DigitDistort()
    {
        ...
        float[] dist = generate(Highgui.imread("num_training\\0.png"));//generate(Highgui.imread(iCloudLatest().getAbsolutePath()));
